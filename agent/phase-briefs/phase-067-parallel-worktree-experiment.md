# Delta Phase 67: parallel-worktree-experiment
...
- Phase: 67
- Name: parallel-worktree-experiment
- Repo: site
...
npm run agent:orchestrate -- --phase 67 --name parallel-worktree-experiment --routine worktree-experiment --mode parallel-plan
```
...
```bash
npm run agent:phase:start -- --phase 67 --name parallel-worktree-experiment --print
```

- Expected branch: `phase-67-parallel-worktree-experiment`
- Expected worktree path: `/Users/egeng/delta-worktrees/site-phase-67-parallel-worktree-experiment`
...
```bash
npm run agent:phase:handoff -- --phase 67
```
