# Delta Phase 68: os-access-boundary
...
npm run agent:orchestrate -- --phase 68 --name os-access-boundary --routine desktop
```
...
```bash
npm run agent:phase:start -- --phase 68 --name os-access-boundary --print
```

- Expected branch: `phase-68-os-access-boundary`
- Expected worktree path: `/Users/egeng/delta-worktrees/site-phase-68-os-access-boundary`
...
```bash
npm run agent:phase:handoff -- --phase 68
```
