# Delta Phase 87: domain-aware-evals
...
npm run agent:orchestrate -- --phase 87 --name domain-aware-evals --routine eval-update
```
...
```bash
npm run agent:phase:start -- --phase 87 --name domain-aware-evals --print
```

- Expected branch: `phase-87-domain-aware-evals`
- Expected worktree path: `/Users/egeng/delta-worktrees/site-phase-87-domain-aware-evals`
...
```bash
npm run agent:phase:handoff -- --phase 87
```
