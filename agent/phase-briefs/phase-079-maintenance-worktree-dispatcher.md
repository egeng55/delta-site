# Delta Phase 79: maintenance-worktree-dispatcher
...
- Phase: 79
- Name: maintenance-worktree-dispatcher
- Repo: site
- Routine: docs-only
- Mode: single
...
npm run agent:orchestrate -- --phase 79 --name maintenance-worktree-dispatcher --routine docs-only
```
...
```bash
npm run agent:phase:start -- --phase 79 --name maintenance-worktree-dispatcher --print
```

- Expected branch: `phase-79-maintenance-worktree-dispatcher`
- Expected worktree path: `/Users/egeng/delta-worktrees/site-phase-79-maintenance-worktree-dispatcher`
...
```bash
npm run agent:phase:handoff -- --phase 79
```
